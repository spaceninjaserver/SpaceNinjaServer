import { fromOid, toMongoDate, version_compare } from "../../helpers/inventoryHelpers.ts";
    ...
    if ((req.query.mode as string) == "f") {
        ...
        if (!inventory.noNemesis) {
            inventory.Nemesis = {
                ...
                ShoulderHelmet: body.target.ShoulderHelmet || getFallbackHelmet(body.target.KillingSuit),
                WeaponIdx: weaponIdx,
