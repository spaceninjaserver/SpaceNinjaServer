...
dict = {
    ...
    market_restartNote: `启用后，游戏原有的商城首页标签将全部隐藏，商城首页只显示下方已启用的服务端标签。保存后服务端会通知游戏刷新世界状态，通常只需重新打开商城。`,
    market_settings: `商城设置`,
    market_enabled: `启用服务端商城页面`,
    market_useMetadataPatch: `双端商城模式`,
    market_useMetadataPatchNote: `服务端实时模式会为每件商品下发一条动态记录，商品过多可能导致游戏卡顿或崩溃。<br>勾选后，服务端管理标签和商品归属，元数据补丁管理价格、货币和上下架。<br>商城内容修改后，请重新生成补丁并完全重启游戏。取消勾选可恢复服务端实时模式。`,
    market_generateMetadataPatch: `生成元数据补丁`,
    market_metadataPatchEmpty: `商城管理中没有可生成补丁的商品。`,
    market_metadataPatchSaved: `已生成包含 |COUNT| 件商品的商城元数据补丁；完全重启游戏后生效。`,
    market_savePickerUnsupported: `当前浏览器不支持 Windows 文件保存窗口，请使用 Chromium 内核浏览器打开网页管理界面。`,
    market_categories: `商城标签`,
    market_items: `商城商品`,
    market_addItem: `添加商品`,
    market_addAll: `全部添加`,
    ...
    market_currency: `货币`,
    market_price: `价格`,
    market_saved: `商城目录已保存发布。`,
    market_needCategory: `请先新增一个商城标签页。`,
