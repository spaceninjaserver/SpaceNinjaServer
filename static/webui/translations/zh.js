...
dict = {
    ...
    market_convertOriginalPlatinum: `将原本的白金商品改为现金（1 白金 = 5,000 现金）`,
    market_categories: `商城标签`,
    market_items: `商城商品`,
    market_addItem: `添加商品`,
    market_addAll: `全部添加`,
    market_allAdded: `已添加 |COUNT| 件商品；点击“保存并发布”后生效。`,
    market_on: `启用`,
    ...
    market_primeImported: `已导入 |COUNT| 件 Prime 商品；点击“保存并发布”后生效。`,
    admin_possess: `管理此账户`,
