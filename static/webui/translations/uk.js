...
dict = {
    ...
    code_rarityCommon: `Звичайна`,
    code_rarityUncommon: `Незвичайна`,
    code_rarityRare: `Рідкісна`,
    code_rarityLegendary: `Легендарна`,
    ...
    code_shieldFlux: `Переспрямування щита`,
    code_marathon: `Марафон`,
    code_quickRest: `Перепочинок`,
    code_secondWind: `Друге дихання`,
    ...
    code_addItemsConfirm: `Ви впевнені, що хочете додати |COUNT| предмет(ів) на ваш обліковий запис?`,
    ...
    code_addVaultItemsConfirm: `Ви впевнені, що хочете додати |COUNT| предмет(ів) до сховища вашого клану?`,
    ...
    code_derelictKey: `Орокінський блукач: |MISSION_TYPE|`,
    ...
    worldState_lunarNewYear: `Місячний Новий рік`,
    ...
    upgrade_WarframeElectricDamage: `Дає +|VAL1|% до Електричної шкоди від основної зброї. Додатково дає +|VAL2|% за споряджений багряний, блакитний чи фіолетовий архонтовий уламок (Поєднується з модифікаторами).`,
    ...
    AVATAR_ARMOUR: `Захист`,
    AVATAR_ENEMY_RADAR: `Виявлення Ворогів`,
    AVATAR_HEALTH_MAX: `Здоров’я`,
    AVATAR_LOOT_RADAR: `Виявлення Здобичі`,
    AVATAR_POWER_MAX: `Гранична Енергія`,
    AVATAR_SHIELD_MAX: `Потужність Щита`,
    AVATAR_SHIELD_RECHARGE_RATE: `Відновлення Щитів`,
    AVATAR_SPRINT_SPEED: `Швидкість`,
    WEAPON_AMMO_MAX: `Запас Набоїв`,
    WEAPON_ARMOR_PIERCING_DAMAGE: `[UNTRANSLATED] Armor Piercing Damage`,
    WEAPON_CLIP_MAX: `Місткість Магазину`,
    WEAPON_CRIT_CHANCE: `Імовірність Критичної Шкоди`,
    WEAPON_CRIT_DAMAGE: `Критична Шкода`,
    WEAPON_DAMAGE_AMOUNT: `Шкода`,
    WEAPON_ELECTRICITY_DAMAGE: `Електрична Шкода`,
    WEAPON_FIRE_DAMAGE: `Термічна Шкода`,
    WEAPON_FIRE_ITERATIONS: `Мультипостріл`,
    WEAPON_FIRE_RATE: `Швидкострільність`,
    WEAPON_FREEZE_DAMAGE: `Крижана Шкода`,
    WEAPON_MELEE_CHARGE_RATE: `[UNTRANSLATED] Heavy Attack Charge Speed`,
    WEAPON_MELEE_DAMAGE: `Шкода Від Холодної Зброї`,
    WEAPON_MELEE_FIRE_RATE: `Швидкість Атаки`,
    WEAPON_MELEE_HEAVY_DAMAGE: `[UNTRANSLATED] Heavy Attack Damage`,
    WEAPON_PUNCTURE_DEPTH: `Пробивання`,
    WEAPON_RELOAD_SPEED: `Швидкість Перезаряджання`,
