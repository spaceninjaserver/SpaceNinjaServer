...
dict = {
    ...
    code_lawOfRetributionBp: `DAS GESETZ DER VERGELTUNG BLAUPAUSE`,
    code_lawOfRetributionNm: `DAS GESETZ DER VERGELTUNG (ALBTRAUM)`,
    code_lawOfRetributionNmBp: `DAS GESETZ DER VERGELTUNG (ALBTRAUM) BLAUPAUSE`,
    code_jordasVerdict: `DAS JORDAS-URTEIL`,
    code_jordasVerdictBp: `DAS JORDAS-URTEIL BLAUPAUSE`,
    code_derelictAssassinate: `Orokin Wrack (Attentat)`,
    code_derelictAssassinateBp: `Orokin Wrack (Attentat) BLAUPAUSE`,
    code_derelictCapture: `Orokin Wrack (Gefangennahme)`,
    code_derelictCaptureBp: `Orokin Wrack (Gefangennahme) BLAUPAUSE`,
    code_derelictDefense: `Orokin Wrack (Verteidigung)`,
    code_derelictDefenseBp: `Orokin Wrack (Verteidigung) BLAUPAUSE`,
    code_derelictExterminate: `Orokin Wrack (Auslöschung)`,
    code_derelictExterminateBp: `Orokin Wrack (Auslöschung) BLAUPAUSE`,
    code_derelictMobileDefense: `Orokin Wrack (Mobile Verteidigung)`,
    code_derelictMobileDefenseBp: `Orokin Wrack (Mobile Verteidigung) BLAUPAUSE`,
    code_derelictSabotage: `Orokin Wrack (Sabotage)`,
    code_derelictSabotageBp: `Orokin Wrack (Sabotage) BLAUPAUSE`,
    code_derelictSurvival: `Orokin Wrack (Überleben)`,
    code_derelictSurvivalBp: `Orokin Wrack (Überleben) BLAUPAUSE`,
    code_vayHekKeyBp: `Vay Hek Frequenz-Triangulator BLAUPAUSE`,
