...
dict = {
    ...
    code_metadataPatchRequired: `要在游戏中看到此物品,需要安装元数据补丁.`,
    ...
    mods_mods: `Mods`,
    mods_addMax: `满级添加`,
    mods_addMissingUnrankedMods: `添加所有缺失的Mod`,
    mods_removeUnranked: `删除所有未升级的Mod`,
    mods_addMissingMaxRankMods: `添加所有缺失的满级Mod`,
    mods_removeRanked: `删除所有已升级的Mod`,
    ...
    cheats_infiniteDirac: `无限狄拉克核心 (U27-U29.10)`,
    ...
    cheats_noVendorPurchaseLimits: `商店或商人无购买限制`,
    ...
    cheats_relicPlatinumBonusCommon: `虚空遗物 常见奖励 白金加成`,
    cheats_relicPlatinumBonusUncommon: `虚空遗物 罕见奖励 白金加成`,
    cheats_relicPlatinumBonusRare: `虚空遗物 稀有奖励 白金加成`,
    ...
    worldState_resourceBoostMultiplier: `资源加成倍率(0为禁用)`,
    worldState_resourceBoostMultiplierDesc: `资源加成倍率说明：除0、1、2、5或10外,其他数值会导致虚空裂隙任务中反应物拾取异常.`,
    worldState_tennoLiveRelay: `TennoLive中继站`,
    worldState_baroTennoConRelay: `Baro的TennoCon中继站`,
    worldState_saintPatrick: `圣帕特里克节`,
    worldState_prideOverride: `骄傲月`,
    ...
    worldState_classicAlerts: `警报任务`,
    worldState_classicAlertsOnAllVersions: `为所有版本启用警报任务`,
    worldState_classicAlertsUpTo: `警报任务启用至U24.3`,
    normal: `正常`,
    ...
    import_samples_resetSortieCompletion: `重置突击&执刑官狩猎完成状态`,
    ...
    admin_users: `用户`,
    market_save: `保存发布`,
    market_reload: `放弃修改并重新载入`,
    market_addCategory: `新增标签`,
    market_importPrime: `导入全部 Prime 商品`,
    market_restartNote: `启用后，游戏原有的商店首页标签将全部隐藏，商店首页只显示下方已启用的服务端标签。保存后服务端会通知游戏刷新世界状态，通常只需重新打开商店。`,
    market_settings: `商店设置`,
    market_enabled: `启用服务端商店页面`,
    market_useMetadataPatch: `双端商店模式`,
    market_useMetadataPatchNote: `服务端实时模式会为每件商品下发一条动态记录，商品过多可能导致游戏卡顿或崩溃。<br>勾选后，服务端管理标签和商品归属，元数据补丁管理价格、货币和上下架。<br>商店内容修改后，请重新生成补丁并完全重启游戏。取消勾选可恢复服务端实时模式。`,
    market_generateMetadataPatch: `生成元数据补丁`,
    market_metadataPatchEmpty: `商店中没有可生成补丁的商品。`,
    market_metadataPatchSaved: `已生成包含 |COUNT| 件商品的商店元数据补丁；完全重启游戏后生效。`,
    market_savePickerUnsupported: `当前浏览器不支持 Windows 文件保存窗口，请使用 Chromium 内核浏览器打开网页管理界面。`,
    market_generateTennogenCompatibilityPatch: `生成 Tennogen 兼容补丁`,
    market_tennogenCompatibilityPatchNote: `根据当前 Tennogen 物品表生成轻量补丁，仅解除 Steam 和平台限制，不修改价格、货币、上下架或商店标签。请保存到 OpenWF\\Metadata Patches，并移除旧的 Tennogen Platinum.txt；物品表更新后重新生成，完全重启游戏后生效。`,
    market_tennogenCompatibilityPatchEmpty: `当前 Tennogen 物品表为空，无法生成兼容补丁。`,
    market_tennogenCompatibilityPatchSaved: `已生成包含 |COUNT| 件商品的 Tennogen patch；完全重启游戏后生效。`,
    market_categories: `商店标签`,
    market_items: `商店商品`,
    market_addItem: `添加商品`,
    market_addAll: `全部添加`,
    market_allAdded: `已添加 |COUNT| 件商品；点击“保存发布”后生效。`,
    market_on: `启用`,
    market_categoryId: `标签 ID`,
    market_categoryName: `分类`,
    market_icon: `现有商店图标`,
    market_icon_newplayer: `新玩家`,
    market_icon_new: `新物品`,
    market_icon_popular: `热门`,
    market_icon_seasonal: `季节性`,
    market_icon_community: `社区`,
    market_icon_heirloom: `传家宝`,
    market_icon_tennogen: `创意工坊`,
    market_icon_sale: `促销`,
    market_icon_wishlist: `愿望单`,
    market_icon_quickbuy: `热销商品`,
    market_icon_primeaccess: `PRIME ACCESS`,
    market_filter: `按名称或资源路径筛选`,
    market_convertToPlatinum: `批量转白金`,
    market_convertToCredits: `批量转现金`,
    market_colorPalettes: `调色盘`,
    market_seasonalItems: `季节性`,
    market_ampParts: `增幅器部件`,
    market_kitgunParts: `组合枪部件`,
    market_zawParts: `Zaw 部件`,
    market_kDriveParts: `K 式悬浮板部件`,
    market_moaParts: `恐鸟部件`,
    market_houndParts: `机器猎犬部件`,
    market_infestedCompanionParts: `感染同伴部件`,
    market_miscItems: `材料与杂项`,
    market_tennogen: `创意工坊`,
    market_glyphs: `浮印`,
    market_bundleGlyphs: `浮印组合包`,
    market_bundleGenes: `动物同伴外观`,
    market_bundleBoosters: `加成组合包`,
    market_bundleMods: `MOD 组合包`,
    market_bundleIncarnons: `灵化组合包`,
    market_bundleHeirlooms: `传家宝组合包`,
    market_bundleNoggles: `摇头娃娃组合包`,
    market_bundles: `组合包`,
    market_itemPath: `选择物品，或输入 /Lotus/... 资源路径`,
    market_credits: `现金`,
    market_platinum: `白金`,
    market_product: `商品`,
    market_currency: `货币`,
    market_price: `价格`,
    market_saved: `商店目录已保存发布。`,
    market_needCategory: `请先新增一个商店标签页。`,
    market_badPath: `物品路径必须以 /Lotus/ 开头。`,
    market_duplicateItem: `这个商品已经存在于目录中。`,
    market_confirmAddAll: `确定要把当前分类中尚未添加的 |COUNT| 件商品全部加入吗？`,
    market_primeImported: `已导入 |COUNT| 件 Prime 商品；点击“保存发布”后生效。`,
    admin_possess: `管理此账户`,
    ...
    AVATAR_ABILITY_RANGE: `技能范围`,
    AVATAR_ABILITY_STRENGTH: `技能强度`,
